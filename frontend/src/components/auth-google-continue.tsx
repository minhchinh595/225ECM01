    ...
    <div className={cn("flex flex-col gap-3", className)}>
      ...
      <div className="grid grid-cols-2 gap-2.5">
        <Button
          ...
          variant="outline"
          className={cn(
            "h-11 w-full gap-2.5 rounded-xl border-stone-200/90 bg-white/90 px-4 text-[14px] font-semibold text-stone-800 shadow-sm",
        ...
        <Button
          ...
          className={cn(
            "h-11 w-full gap-2.5 rounded-xl border-stone-200/90 bg-white/90 px-4 text-[14px] font-semibold text-stone-800 shadow-sm",
            "transition-[border-color,box-shadow,background-color] duration-200",
            "hover:border-[#1877F2]/30 hover:bg-[#f0f5ff] hover:shadow-md",
            "focus-visible:border-[#1877F2]/40 focus-visible:ring-[#1877F2]/20",
          )}
