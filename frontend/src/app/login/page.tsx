  ...
  return (
    <div className="grid min-h-svh lg:grid-cols-[1fr_calc(100svh*9/16)]">
      ...
      <div className="relative flex flex-col overflow-hidden">
        ...
        {/* Form card — đè lên ảnh nền */}
        <div className="relative z-10 flex flex-1 items-center justify-center px-6 pb-12 md:px-10">
          <div className="w-full max-w-[28rem]">
            <div className="rounded-[1.75rem] border border-white/70 bg-white/85 px-8 py-6 shadow-[0_24px_80px_rgba(88,62,39,0.16)] backdrop-blur-xl sm:px-10 sm:py-7">
              <LoginForm />
            </div>
          </div>
        </div>
